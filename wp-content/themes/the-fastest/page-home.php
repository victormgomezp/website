      ...
      <div class="header-content">
        <div class="row">
          <div class="col-sm-10 col-md-10 col-lg-9 col-xl-7 mx-auto">
            <h1 id="homeHeading">&#x3C;/ Breathe Coding &#x3E;</h1>
            <h3><span class="text-orange">[ </span><span class="text-blue">coding education</span>, <span class="text-blue">affordale</span>, <span class="text-blue"> part time.</span> <span class="text-orange">] </span></h3>
          </div>
        </div>
