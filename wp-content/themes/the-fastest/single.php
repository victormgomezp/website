	...
	<div class="row">
		...
		<div class="col-md-2 col-xs-12">
			<div class="share">
				...
				<ul>
					<li>
					<a target="_blank" href="https://twitter.com/home?status=<?php echo urlencode(get_the_permalink()); ?>">
...
<!-- Begin Top Meta -->
			...
			<div class="after-post-tags">
				...
				<ul class="tags">
					<?php if(!empty($tags) && is_array($tags)) foreach($tags as $t){ ?>
...
<div class="alertbar bg-light">
	<div class="row">
		...
		<div class="col-12 col-sm-2 col-xl-1 mr-auto text-center pl-3 pt-2">
			<a href="<?php echo get_permalink( get_page_by_path( wpas_pll_get_slug('calendar') ) ); ?>" class="btn btn-danger">Learn More</a>
		</div>
	</div>
</div>
<!-- End AlertBar
