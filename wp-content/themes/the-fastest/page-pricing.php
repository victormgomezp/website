        ...
        <div class="row">
          <div class="col-sm-12 col-md-5 col-lg-3 mx-auto order-2 order-md-1">
            <svg width="270" height="240" class="mt-0">
              ...
              <text x="180" y="65" fill="white">Quality</text>
              <text x="40" y="65" fill="white">Price</text>
              <text x="110" y="185" fill="white">Placement</text>
            </svg>
          </div>
      ...
      <div class="container">
        <div class="row mb-4">
          <div class="col-md-6 mx-auto">
            <h4 class='text-center'>Pick your payment plan, no extra fees or hidden costs, everything is included: </h4>
          </div>
        </div>
        <div class='row'>
          <div class='col-md-6 ml-auto upfront'>
            <div class="card card-block card-primary card-inverse bg-yellow mb-3">
              <div class="card-body">
                <h5 class="card-title m-0 text-center">Upfront</h5>
                <h4 class="card-text text-center">$6,000</h4>
              </div>
              <div class="card-footer">
                <h5 class='text-center mb-3'>
                  Yes, we know... The best price in town.
                </h5>
              </div>
            </div>
          </div>
          <div class='col-md-6 mr-auto'>
            <div class="card card-block card-primary card-inverse bg-yellow payment-plan">
              <div class="card-body">
                <h5 class="card-title m-0 text-center">Or Extended Payment Plan</h5>
